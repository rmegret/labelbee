...
USER_AFTER_LOGIN_ENDPOINT = 'auth.user_page'
...
USER_AFTER_CHANGE_PASSWORD_ENDPOINT = 'auth.user_page'
USER_AFTER_CHANGE_USERNAME_ENDPOINT = 'auth.user_page'
USER_AFTER_CONFIRM_ENDPOINT = 'auth.user_page'
USER_AFTER_EDIT_USER_PROFILE_ENDPOINT = 'auth.user_page'
USER_AFTER_FORGOT_PASSWORD_ENDPOINT = 'auth.user_page'
USER_AFTER_REGISTER_ENDPOINT = 'auth.user_page'
USER_AFTER_RESEND_EMAIL_CONFIRMATION_ENDPOINT = 'auth.user_page'
USER_AFTER_RESET_PASSWORD_ENDPOINT = 'auth.user_page'
USER_AFTER_INVITE_ENDPOINT = 'auth.user_page'
USER_UNAUTHORIZED_ENDPOINT = 'home.home_page'
