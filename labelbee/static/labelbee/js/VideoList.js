...
VideoManager.prototype.setVideoInfo = function(videoInfoJSON){
  videoinfo = {
    name: "/webapp-test/data/videos/Gurabo/C01_170805083044.mp4".split('/').pop(),//videoInfoJSON["videoURL"].split('/').reverse()[0],
    videoURL: "/webapp-test/data/videos/Gurabo/C01_170805083044.mp4",//videoInfoJSON["videoURL"],
