...
Revision ID: 52e4a560cd6b
Revises: 
Create Date: 2021-06-09 15:10:25.552890
...
def upgrade():
    ...
    sa.Column('studentnum', sa.Unicode(length=50), server_default='', nullable=False),
    sa.Column('clase', sa.Unicode(length=50), server_default='', nullable=False),
    sa.PrimaryKeyConstraint('id'),
